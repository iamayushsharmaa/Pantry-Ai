  ...
  GoRoute(
    ...
    builder: (_, state) {
      ...
      final prefs = TastePreferences(
        taste: args['taste'] as String,
        cuisine: args['cuisine'] as String,
        diet: args['diet'] as String,
        maxCookingTime: args['maxCookingTime'] as int,
      );
      ...
      return BlocProvider(
        create: (_) => RecipeBloc(
          ...
          getCachedRecipes: sl(),
          cacheRecipes: sl(),
        )..add(GenerateRecipesRequested(args["imagePath"] as String, prefs)),
